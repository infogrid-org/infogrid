...
import org.infogrid.web.taglib.rest.AbstractRestInfoGridBodyTag;
        ...
        AbstractRestInfoGridBodyTag
{
            ...
            IgnoreException
    {
        ...
        TraversalTranslator translator = getInfoGridWebApp().getContext().findContextObject( TraversalTranslator.class );
        if( translator == null ) {
            return theAddArguments;
        }
        ...
        try {
            ...
            for( int i=0 ; i<args.length ; ++i ) {
                HTTP.appendArgumentToUrl( buf, WebMeshObjectsToView.LID_TRAVERSAL_ARGUMENT_NAME, args[i] );
            }
            return buf.toString();
