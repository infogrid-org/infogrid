            ...
            AbstractInfoGridTag
{
            ...
            IOException
    {
        ...
        StructuredResponse outerStructured = (StructuredResponse) pageContext.getResponse();
        StructuredResponse innerStructured = StructuredResponse.create( pageContext.getServletContext() );
        ...
        if( !innerStructured.isEmpty() ) {
            Iterator<String> iter = innerStructured.sectionNameIterator();
            while( iter.hasNext() ) {
                ...
                if( StructuredResponse.MAIN_SECTION.equals( name )) {
                    ...
                    here.appendTextContent( there.getTextContent() );
                }
