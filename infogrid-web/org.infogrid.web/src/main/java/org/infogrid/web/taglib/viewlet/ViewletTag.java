            ...
            AbstractInfoGridBodyTag
{
    ...
    public int realDoStartTag()
        throws
            JspException
    {
        WebViewlet vl = (WebViewlet) pageContext.getRequest().getAttribute( WebViewlet.VIEWLET_ATTRIBUTE_NAME );

        StringBuilder content = new StringBuilder( 256 );

        if( !DefaultWebViewletStateEnum.VIEW.getName().equals( vl.getViewletState().getName() )) { // compare Strings, enum's won't allow equals() override
