        ...
        AbstractInfoGridTag
{
            ...
            IgnoreException
    {
        ...
        WebMeshObjectsToViewFactory toViewFact = c.findContextObjectOrThrow( WebMeshObjectsToViewFactory.class );
        ...
        if( candidates.length > 0 ) {
            ...
            pars.put( WebViewlet.PANE_STRING_REPRESENTATION_PARAMETER_KEY,     thePane );
            pars.put( WebViewletFactoryChoice.VIEWEDMESHOBJECTS_STACK_KEY,     saneRequest.getAttribute( IncludeViewletTag.PARENT_STACK_ATTRIBUTE_NAME ));
