...
package org.infogrid.web.taglib.candy;
        ...
        AbstractInfoGridBodyTag
{
     ...
     *
     * @param content the content in the main section
     * @throws JspException thrown if an evaluation error occurred
     * @throws IOException thrown if an I/O Exception occurred
     */
     ...
     *
     * @param content the content in the ifcontent section
     * @throws JspException thrown if an evaluation error occurred
     * @throws IOException thrown if an I/O Exception occurred
     */
     ...
     *
     * @param content the content in the notifconfig section
     * @throws JspException thrown if an evaluation error occurred
     * @throws IOException thrown if an I/O Exception occurred
     */
