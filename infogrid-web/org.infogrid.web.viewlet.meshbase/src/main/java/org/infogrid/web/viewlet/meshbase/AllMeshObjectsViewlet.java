...
import jsps.org.infogrid.web.viewlet.meshbase.AllMeshObjectsViewlet_jsp;
...
import org.infogrid.web.viewlet.AbstractPagingCursorIterableViewlet;
import org.infogrid.web.viewlet.DefaultWebViewedMeshObjects;
import org.infogrid.web.viewlet.DefaultWebViewletFactoryChoice;
            ...
            AbstractPagingCursorIterableViewlet
{
            ...
            Context  c )
    {
        ...
        AllMeshObjectsViewlet       ret    = new AllMeshObjectsViewlet(
                AllMeshObjectsViewlet.class.getName(),
                AllMeshObjectsViewlet_jsp.class,
                viewed,
                DEFAULT_PAGE_SIZE,
                c );
    ...
    public static ViewletFactoryChoice choice(
            ...
            double               matchQuality )
    {
        return new DefaultWebViewletFactoryChoice( toView, AllMeshObjectsViewlet.class, matchQuality ) {
                @Override
    ...
    protected AllMeshObjectsViewlet(
            ...
            Context                  c )
    {
        super( viewletName, servletClass, viewed, defaultPageLength, c );
    }
     ...
     */
    protected static final Comparator<MeshType> theByUserVisibleNameComparator = ( MeshType one, MeshType two ) -> {
